...
{
class DdsToRosDestinationBridge : public DdsToRosBridge
{
public:
    DdsToRosDestinationBridge(ros::NodeHandle& nh);
    virtual ~DdsToRosDestinationBridge();

    std::string ros_topic() const override { return "destination"; }
    std::string dds_topic() const override { return "destination"; }
...
private:
    ...
    {
    public:
        explicit ReaderListener(DdsToRosDestinationBridge* parent) : parent_(parent) {}
        void on_data_available(DataReader* reader) override;
    private:
        DdsToRosDestinationBridge* parent_;
    };
